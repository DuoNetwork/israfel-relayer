...
export const DB_PAIR_DATE_HOUR = 'pairDateHour';
export const DB_TS_TX_HASH = 'timestampTransactionHash';
export const DB_TK_OH = 'takerOrderHash';
export const DB_TK_ADDR = 'takerAddress';
export const DB_TK_SIDE = 'takerSide';
...
export const EXPIRY_MARGIN_MS = 180000;
